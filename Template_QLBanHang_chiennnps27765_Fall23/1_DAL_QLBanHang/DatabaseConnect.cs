...
namespace _1_DAL_QLBanHang
{
    ...
    {
        // Kết nối dành cho localDb <= VER 1
        ...
        // Kết nối đến Azure Sql <= VER 2

        private const string azureConnection = @"Server=tcp:chienprivate.database.windows.net,1433;Initial Catalog=QuanLyBanHang;Persist Security Info=False;User ID=chienprivate28;Password=Chienprivate@;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
